...
headers = {
    ...
    "if-none-match": 'W/"674-i6SwegFXRix5WQdE+1j1yztATCk"',
    ...
    "traceparent": "00-ce7aaf43d3c5c3f712bc52b87ceddb2a-060738cfab7e10a4-01",
    "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36",
    "x-client-app": "web",
}

response = requests.get(
    "https://cs.money/1.0/market/notifications", cookies=cookies, headers=headers
)
